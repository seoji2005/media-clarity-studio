...
| 주요 병합 PR | **#1·#5·#16·#18·#19·#21·#22·#23·#24·#25·#28·#33·#34·#36·#42·#45·#47·#48·#50·#51·#52·#53·#54·#55·#56·#57·#59·#60·#61** — TASK-032 계약 merge는 `dd3e78645e9ece7fffd8843c10ba37abcdde0a8e`; TASK-031 exact synthetic matrix merge는 `557b52f4d25ae377aa492b3cb176dd174e7a4fb9`, 상태 정합화 merge는 `0c0f40ea318aff8b69180c9c6f510a627b0e0b9c` |
...
| 현재 작업 | **TASK-032** — Gate H 승인과 PR #61 계약 병합 완료. 첫 구현 slice는 deterministic schema/fixture/harness와 무료 Work-CPU preflight이며, 부모 TASK-031의 exact 8-run/12-stage closed set은 변경하지 않음 |
| U-31 | **답변됨 (2026-08-22)** — 번역 대상 언어 **한국어(`ko`)** |
| 다음 실행 의존성 | TASK-032 계약 병합 완료 → deterministic schema/fixture/harness와 무료 Work-CPU preflight를 별도 구현 PR로 착수. 실제 target-hardware 판정은 Windows 접근 뒤 lock·environment/CUDA evidence와 승인된 exact-revision model receipt가 필요 |
...
| [TASK-032](docs/tasks/TASK-032.md) | 공개·합성 frozen pack 3-ASR Work-CPU screening | Lean Root Author | fresh GPT/Codex Gate H reviewer | Phase 1a ASR candidate screening | **In progress — Gate H 승인, PR #61 계약 병합 (`dd3e78645e9ece7fffd8843c10ba37abcdde0a8e`)**, 첫 구현 slice 미착수; TASK-031 후보·8/12 계약은 변경하지 않음 |
...
| [TASK-032](docs/tasks/TASK-032.md) | 공개·허가·합성 frozen pack 3-ASR Work-CPU screening — Gate H 승인과 PR #61 계약 병합 완료; deterministic schema/fixture/harness와 무료 Work-CPU preflight가 다음 단일 구현 slice | Lean Root Author |

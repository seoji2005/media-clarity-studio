...
마지막 갱신: 2026-08-09 (Phase 0 병합 완료 · U-08·U-11 답변 반영 — TASK-012)
...
### Phase 1a 실행 순서 (TASK-012가 확정 — [`PLAN.md`](PLAN.md) §3-1d)

| 순서 | 후보 | 내용 | 선행 |
|---|---|---|---|
| **1** | **TASK-003** | seed 코퍼스·라이선스·합성 데이터 대안 조사 + 비교표 작성 | **없음 — 지금 착수 가능** |
| 2 | (사람) | 제품 오너가 조사 비교표를 보고 **U-06 선택** | TASK-003 결과 |
| 3 | TASK-005 | 평가 하네스 설계 명세 (Phase 1a) | U-06 선택, TASK-003 |
| 4 | TASK-006 | `ReferenceBundle/v1` 구체화 | TASK-003 |
...
| **U-31 — 번역 대상 언어** | **Phase 1 번역 단계 설계** (TASK-005·006 전 또는 병행) | 사람 제품 오너 |

...
마지막 갱신: 2026-08-25 (TASK-006 계약 제안)
현재 단계: **Phase 1a** — TASK-006 Gate H 계약 검토
...
| 현재 작업 | **TASK-006 계약 검토** — Gate H schema·fixture 계약 제안, 구현 대기 |
| U-31 | **답변됨 (2026-08-22)** — 번역 대상 언어 **한국어(`ko`)** |
| 다음 실행 의존성 | **TASK-006 계약 승인·병합** → Claude Code 구현 → 고정 HEAD 검토 |
...
| [TASK-006](docs/tasks/TASK-006.md) | ReferenceBundle/v1 및 평가 실행 계약 구체화 | Claude Code 구현 세션 | Lean Root 고정 HEAD 검토 | Phase 1a evaluation contracts | **Contract proposed — 구현 전** |
...
| TASK | 내용 | Owner |
|---|---|---|
| [TASK-006](docs/tasks/TASK-006.md) — 계약 검토 | `ReferenceBundle/v1`과 평가 run/report schema·H-01~H-14 fixture 구체화 | Lean Root 계약 → Claude Code 구현 (Gate H) |
...
| **TASK-006** | `ReferenceBundle/v1` 및 평가 실행 계약 구체화 | **TASK-005** | **계약 검토 중** |
| 코드 구현 | TASK-006 schema·validator·fixture | TASK-006 계약 승인·병합 | 대기 |

> **TASK-005 평가 하네스 설계는 완료됐습니다.** TASK-006 Gate H 계약은 현재 제안 상태입니다.
> 계약 승인·병합 뒤 Claude Code가 schema·validator·fixture를 구현하며, Lean Root는 고정 HEAD를 직접 검증합니다.

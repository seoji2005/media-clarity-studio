...
| 차단 요인 | **U-31 차단 해제.** 정밀 일정은 정확한 제출 날짜를 기다리며, TASK-005는 TASK-003 완료·U-06 선택을 기다림 (§4·§5) |
...
| **TASK-003** | seed 코퍼스·라이선스·합성 데이터 대안 조사 + 비교표 작성 | **없음 — 지금 착수 가능** | 차단 없음 |
| **(사람) U-06 선택** | 제품 오너가 조사 비교표를 보고 선택 | TASK-003 결과 | 차단 없음 |
...
> **다음 실행 후보는 TASK-003/PR #12의 Gate E 잔여 완료입니다.** ADR-0024에 따라 에이전트가
> 조사하고, 오너는 비교표를 보고 U-06을 선택합니다. U-31은 더 이상 어떤 단계도 막지 않습니다.
...
| **U-06 — seed 코퍼스 최종 선택** | **TASK-005 착수.** TASK-003/Gate E 결과를 본 뒤 선택 | 사람 제품 오너 |

...
> **현재 상태 — 2026-08-22 (아래 2026-08-12 역사 기록보다 우선):**
>
...
> 2026-08-12~Gate S 시점의 역사 기록으로 보존하며 현재 결론으로 확대하지 않는다.
...
> **현재 처분 (2026-08-22): 제외.** Durian 3개 본문 직접 요청이 모두 402로 실패했다.
> 아래 내용은 2026-08-12 조사 기록이며 현재 사용 승인이 아니다. 원문 직접 검증이 가능한
> 별도 후속 작업이 승인될 때만 후보를 다시 연다.
...
> **현재 처분 (2026-08-22): M-03 직접 근거 확보, 독립 리뷰 대기.** SLR150 배포본의
> CC BY-SA 4.0 표시와 연결 LICENSE, historical CHiME-5 접근 조건, 현 steward의 CHiME-5/6
> 구분이 기존 정정과 일치했다. 다른 배포본·원 녹음의 권리로 일반화하지 않는다.
...
4. 사람 제품 오너가 비교표를 보고 U-06을 선택한다. U-31은 한국어(`ko`)로 이미 해소됐다.
5. TASK-005 평가 하네스 설계 명세와 TASK-006 `ReferenceBundle/v1` 구체화를 순서대로 완료한다.
   **이 순서는 그대로 유지된다.**
6. **Gate E 독립 리뷰** — 아래 직접 증거와 M-05 보수적 제외가 범위를 과장하지 않는지 고정 HEAD에서 검토한다. 승인 전에는 CHiME-6를 채택·다운로드·재배포하지 않는다.
7. Sintel은 현재 제외 상태다. 실제 미디어 acceptance가 필요하면 검증 가능한 새 후보를 별도 조사한다.

## 10.3 Gate E 직접 검증 증거 — 2026-08-22

> **Gate H 구현 증거이며 자기 승인이 아니다.** 독립 Reviewer가 고정 HEAD에서 범위와 결론을 검토한다.

| 대상 | 직접 관측 | 경계 |
|---|---|---|
| [OpenSLR SLR150](https://openslr.org/150/) | CHiME-6, CC BY-SA 4.0, train/dev/eval 97G/11G/12G, transcriptions 2.4M | SLR150 배포본 한정 |
| [SLR150 LICENSE](https://openslr.trmal.net/resources/150/LICENSE.txt) | Attribution-ShareAlike 4.0, Barker et al. (2018) citation, CC legal text | attribution·ShareAlike 확인 |
| [CHiME-6 challenge download](https://chimechallenge.github.io/chime6/download.html) | CHiME-5 원자료의 당시 접근 절차와 commercial 2,000 GBP | 현행 SLR150 라이선스가 아닌 역사 문서 |
| [CHiME-5 steward](https://www.chimechallenge.org/datasets/chime5) | CHiME-6 supersede, CHiME-5의 2024-01-01 CC BY-SA 4.0 재발행 | 적용 대상 CHiME-5 |
| [CHiME-6 steward](https://www.chimechallenge.org/datasets/chime6) | 새 작업에 CHiME-6 권고, OpenSLR 다운로드 origin 연결 | origin 확인 |
| [CC BY-SA 4.0 deed](https://creativecommons.org/licenses/by-sa/4.0/) / [legal code](https://creativecommons.org/licenses/by-sa/4.0/legalcode.en) | attribution, 변경 표시, ShareAlike, 추가 제한 금지 | 법률 자문 아님 |
| [CC BY 3.0 deed](https://creativecommons.org/licenses/by/3.0/) / [legal code](https://creativecommons.org/licenses/by/3.0/legalcode.en) | attribution·추가 제한 금지, 일반적인 entire credit scroll 문구 없음 | Sintel 적용 사실과 분리 |
| Durian sharing/about/download | 세 직접 요청 모두 `402 Payment Required` | M-05 확인 아님; Sintel 제외 |

**처분:** M-03은 독립 리뷰 가능한 직접 근거가 생겼다. M-05는 미확인 사실을 승인하지 않고
후보를 제거해 안전하게 닫았다. CHiME-6도 U-06 결정과 ShareAlike 검토 전에는 다운로드하지 않는다.

## 11. 공식 출처 목록

기존 조사 링크 접근일은 2026-08-12이며, §10.3 직접 검증 링크의 재확인일은 2026-08-22다.
